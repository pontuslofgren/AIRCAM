...
ActiveRecord::Schema[7.1].define(version: 2023_11_21_115916) do
  ...
  create_table "availabilities", force: :cascade do |t|
    ...
    t.index ["camera_id"], name: "index_availabilities_on_camera_id"
  end
  ...
  add_foreign_key "availabilities", "cameras"
